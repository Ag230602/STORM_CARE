...
- det - ens at 6 h: mean storm-level difference +0.000954; raw p=0.00341797, Holm p=0.0136719; ensemble lower Brier supported.
- det - ens at 12 h: mean storm-level difference +0.000926; raw p=0.00805664, Holm p=0.0161133; ensemble lower Brier supported.
- det - ens at 24 h: mean storm-level difference +0.002436; raw p=0.000244141, Holm p=0.00292969; ensemble lower Brier supported.
- det - ens at 48 h: mean storm-level difference +0.001665; raw p=0.000488281, Holm p=0.00341797; ensemble lower Brier supported.
- det - ens at 72 h: mean storm-level difference +0.001142; raw p=0.00488281, Holm p=0.0146484; ensemble lower Brier supported.
- det - ens at 96 h: mean storm-level difference +0.001341; raw p=0.00976562, Holm p=0.0161133; ensemble lower Brier supported.
- P90 - ens at 6 h: mean storm-level difference +0.060097; raw p=0.000244141, Holm p=0.00292969; ensemble lower Brier supported.
- P90 - ens at 12 h: mean storm-level difference +0.068939; raw p=0.000244141, Holm p=0.00292969; ensemble lower Brier supported.
- P90 - ens at 24 h: mean storm-level difference +0.088892; raw p=0.000244141, Holm p=0.00292969; ensemble lower Brier supported.
- P90 - ens at 48 h: mean storm-level difference +0.154580; raw p=0.000244141, Holm p=0.00292969; ensemble lower Brier supported.
- P90 - ens at 72 h: mean storm-level difference +0.279992; raw p=0.000976562, Holm p=0.00585938; ensemble lower Brier supported.
- P90 - ens at 96 h: mean storm-level difference +0.439401; raw p=0.00195312, Holm p=0.00976562; ensemble lower Brier supported.
