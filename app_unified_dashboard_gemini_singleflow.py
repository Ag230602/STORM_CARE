...
def main():
    ...
    st.markdown(
        ...
        <style>
          ...
          /* Make text readable */
          .stMarkdown, .stCaption, .stText, p, li { color: rgba(255,255,255,0.92) !important; }
        </style>
        """,
        unsafe_allow_html=True,
    )
